...
/* Hubo un ambiente de calidad aparte (sgcc-jv-qa) y se retiró: se trabaja sobre
   un único proyecto. Si alguna vez vuelve a hacer falta separarlos, el ambiente
   debe deducirse del dominio y no de una variable de compilación —este proyecto
   no compila—, y todo lo que no sea el dominio de producción debe caer en
   calidad, que es la dirección segura del error.                            */
